...
function normalize(x){
 ...
 return {version:2,transactions,cash,prices,fx:number(x.fx??150,'為替',true),fxUpdatedAt:typeof x.fxUpdatedAt==='string'?x.fxUpdatedAt:'',updatedAt:typeof x.updatedAt==='string'?x.updatedAt:''};
}
