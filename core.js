...
function holdings(transactions){
 ...
 for(const t of [...transactions].sort((a,b)=>a.date.localeCompare(b.date))){
  ...
  if(t.side==='BUY'){h.qty+=t.quantity;h.cost+=(t.amount??t.quantity*t.price/t.priceUnit)+t.fee;}
