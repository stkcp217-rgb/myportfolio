...
async function quote(symbol){
 ...
 const endpoints=[
  ...
  "https://r.jina.ai/http://query1.finance.yahoo.com/v8/finance/chart/"+path+"?range=1d%26interval=1d%26lang=ja-JP%26region=JP"
 ];let last;
